...
<map version="1.0.1">
  <node TEXT="AI Explained Simply — Mistral Studio Series">
    ...
    <node TEXT="Roadmap — next episodes (unwritten)">
      ...
      <node TEXT="Token"><richcontent TYPE="NOTE"><html><body><p>The units a model reads and writes text in.</p></body></html></richcontent></node>
      <node TEXT="Memory"><richcontent TYPE="NOTE"><html><body><p>How an agent remembers things across steps or conversations.</p></body></html></richcontent></node>
      <node TEXT="Skill"><richcontent TYPE="NOTE"><html><body><p>A packaged, reusable capability an agent can call on.</p></body></html></richcontent></node>
      <node TEXT="Hook"><richcontent TYPE="NOTE"><html><body><p>An automatic trigger that runs code at a specific event.</p></body></html></richcontent></node>
      <node TEXT="Fine-tuning"><richcontent TYPE="NOTE"><html><body><p>Teaching a model new habits instead of just prompting it.</p></body></html></richcontent></node>
      <node TEXT="RAG"><richcontent TYPE="NOTE"><html><body><p>Giving a model your own documents to look up before answering.</p></body></html></richcontent></node>
      <node TEXT="JSON"><richcontent TYPE="NOTE"><html><body><p>The plain-text format apps use to hand structured data to each other.</p></body></html></richcontent></node>
      <node TEXT="Python"><richcontent TYPE="NOTE"><html><body><p>The language most AI tools and glue-scripts are written in.</p></body></html></richcontent></node>
    </node>
  </node>
</map>
